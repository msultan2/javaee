...
public class ProductCatalog1ServiceLocator extends org.apache.axis.client.Service implements Server3.ProductCatalog1Service {
    ...
    private java.lang.String productCatalog1_address = "http://localhost:7001/WebServiceWebLogic3/services/productCatalog1";
    ...
    public Server3.ProductCatalog1 getproductCatalog1() throws javax.xml.rpc.ServiceException {
    ...
    public Server3.ProductCatalog1 getproductCatalog1(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Server3.ProductCatalog1SoapBindingStub _stub = new Server3.ProductCatalog1SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Server3.ProductCatalog1.class.isAssignableFrom(serviceEndpointInterface)) {
                Server3.ProductCatalog1SoapBindingStub _stub = new Server3.ProductCatalog1SoapBindingStub(new java.net.URL(productCatalog1_address), this);
                _stub.setPortName(getproductCatalog1WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Server3", "productCatalog1Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Server3", "productCatalog1"));
        }
