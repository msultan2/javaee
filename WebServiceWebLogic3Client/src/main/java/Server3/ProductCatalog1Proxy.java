...
public class ProductCatalog1Proxy implements Server3.ProductCatalog1 {
  private String _endpoint = null;
  private Server3.ProductCatalog1 productCatalog1 = null;
  ...
  private void _initProductCatalog1Proxy() {
    try {
      productCatalog1 = (new Server3.ProductCatalog1ServiceLocator()).getproductCatalog1();
  ...
  public Server3.ProductCatalog1 getProductCatalog1() {
    if (productCatalog1 == null)
      _initProductCatalog1Proxy();
