...
<jsp:useBean id="sampleProductCatalogProxyid" scope="session" class="Server3.ProductCatalogProxy" />
<%
...
case 10:
        gotMethod = true;
        Server3.ProductCatalog getProductCatalog10mtemp = sampleProductCatalogProxyid.getProductCatalog();
