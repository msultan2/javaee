...
public:
    ...
    //static LogHandler* getLogHandler() { return m_logHandler; }

    //static void setLogHandler(LogHandler* pLogger);

    static void setErrorDialog(View::IErrorDialog* errorDialogPtr);
...
private:
    ...
    static LegacyConsoleLogSink* m_pLegacyConsoleLogSink;
    static LegacyFileLogSink* m_pLegacyFileLogSink;
    static ViewLogSink* m_pViewLogSink;
    static View::IErrorDialog* c_errorDialogPtr;
};
