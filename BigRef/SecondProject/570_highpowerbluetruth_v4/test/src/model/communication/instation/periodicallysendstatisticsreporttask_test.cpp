...
using InStation::PeriodicallySendStatisticsReportTask;
...
TEST(PeriodicallySendStatisticsReportTask, statisticalProperties)
{
    ...
    PeriodicallySendStatisticsReportTask task(pInstationReporter, &clock);
    ...
    EXPECT_TRUE(std::find(
            ...
            PeriodicallySendStatisticsReportTask::eSTARTING) != testObserverIndexCollection.end());
    ...
    EXPECT_TRUE(std::find(
            testObserverIndexCollection.begin(),
            testObserverIndexCollection.end(),
            PeriodicallySendStatisticsReportTask::eSENDING_STATISTICS_REPORT) != testObserverIndexCollection.end());
    EXPECT_TRUE(task.isRunning());
    ...
    EXPECT_TRUE(std::find(
            testObserverIndexCollection.begin(),
            testObserverIndexCollection.end(),
            PeriodicallySendStatisticsReportTask::eSTOPPING) != testObserverIndexCollection.end());
