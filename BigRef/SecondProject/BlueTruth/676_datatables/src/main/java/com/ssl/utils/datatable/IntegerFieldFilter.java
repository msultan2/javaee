 ...
 */
public class IntegerFieldFilter extends AbstractFieldFilter implements DataTableFieldFilter {
     ...
     */
    public IntegerFieldFilter(String fieldName, Integer min, Integer max, boolean minInclusive, boolean maxInclusive) {
        super(fieldName);
