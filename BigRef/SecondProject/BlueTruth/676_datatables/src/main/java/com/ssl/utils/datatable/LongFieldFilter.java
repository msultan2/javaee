 ...
 */
public class LongFieldFilter extends AbstractFieldFilter implements DataTableFieldFilter {
     ...
     */
    public LongFieldFilter(String fieldName, Long min, Long max, boolean minInclusive, boolean maxInclusive) {
        super(fieldName);
