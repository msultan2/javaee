...
//Populate configuration collection
db.configuration.insert({name: "host", value: "localhost"});
db.configuration.insert({name: "port", value: "30005"});
db.configuration.insert({name: "path", value: ""});
db.configuration.insert({name: "mongoCheckPeriodInSeconds", value: "5"});
db.configuration.insert({name: "connectTimeoutInSeconds", value: "15"});
db.configuration.insert({name: "responseTimeoutInSeconds", value: "10"});
db.configuration.insert({name: "backoffTimeInSeconds", value: "10"});
db.configuration.insert({name: "numberOfRetries", value: "3"});
db.configuration.insert({name: "numberOfDetectionsPerReportLimit", value: "100"});


//Insert owners into the collection
db.owners.insert({name: "ssl", full_name: "Simulation Systems Ltd"})
db.owners.insert({name: "cv", full_name: "ClearView", send_reports: 1 })
