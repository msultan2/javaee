DO $$
    DECLARE  
        test varchar := 'V3andV4Detections1';
...
RAISE INFO '%', test; 
    ...
    INSERT INTO detector VALUES (v3DetectorId, v3DetectorId, 1, 'North', 'default', 51.276922, -2.917200, 'testing v3 and v4 device ID compatibility', 1553, true);
    INSERT INTO detector VALUES (v4DetectorId, v4DetectorId, 1, 'North', 'default', 50.939127, -3.315839, 'testing v3 and v4 device ID compatibility', 1554, true);
