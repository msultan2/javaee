DO $$
    DECLARE  
        test varchar := 'V3andV4Detections2';
...
RAISE INFO '%', test; 
    ...
    INSERT INTO detector VALUES (v3DetectorId, v3DetectorId, 1, 'North', 'default', 51.603926, -2.938203, 'testing v3 and v4 device ID compatibility', 1555, true);
    INSERT INTO detector VALUES (v4DetectorId, v4DetectorId, 1, 'North', 'default', 51.620612, -2.668836, 'testing v3 and v4 device ID compatibility', 1556, true);
