DO $$
    DECLARE  
        test varchar := 'V3andV4Detections4';
...
RAISE INFO '%', test; 
    ...
    INSERT INTO detector VALUES (v3DetectorId, v3DetectorId, 1, 'North', 'default', 51.520347, -2.523422, 'testing v3 and v4 device ID compatibility', 1559, true);
    INSERT INTO detector VALUES (v4DetectorId, v4DetectorId, 1, 'North', 'default', 51.499582, -2.451475, 'testing v3 and v4 device ID compatibility', 1560, true);
