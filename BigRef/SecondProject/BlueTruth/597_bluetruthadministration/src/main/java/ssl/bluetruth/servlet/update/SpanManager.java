...
public class SpanManager extends HttpServlet {
    ...
    private String INSERT_SPAN_SQL = "INSERT INTO span (span_name, start_detector_id, end_detector_id,journey_time_limit) VALUES(?,?,?,?);";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("insert")) {
            ...
            Integer journeyTimeLimit = Integer.parseInt(request.getParameter("journey_time_limit"));
            ...
            if (logicalGroups == null) {
                ...
                insertSpan(username, name, startDetectorID, endDetectorID, journeyTimeLimit, logicalGroups, result);
                if (result.isSuccess()) {
            ...
            } else if (column.equalsIgnoreCase("8")) {
                updateSpanJourneyTimeLimit(username, "journey_time_limit", name, Integer.parseInt(value), result);
            }
            //SCJS 009 END
    ...
    private void insertSpan(String username, String name, String startDetectorID, String endDetectorID, Integer journeyTimeLimit, String[] logicalGroups, Result result) {
        ...
        try {
            ...
            stmt.setInt(4, journeyTimeLimit);
            stmt.executeUpdate();
    ...
    private void updateSpanJourneyTimeLimit(String username, String column, String name, Integer value, Result result) {
        ...
        try {
            ...
            try {
                dm = DatabaseManager.getInstance();
                connection = dm.getDatasource().getConnection();
            } catch (DatabaseManagerException | NamingException ex) {
                LOGGER.fatal(ex.getMessage());
            }
