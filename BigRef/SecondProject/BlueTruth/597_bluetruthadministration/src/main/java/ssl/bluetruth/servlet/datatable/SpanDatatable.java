 ...
 */
public class SpanDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(SpanDatatable.class);
    ...
    private static final String fileName = "spans.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Journey Time Limit", "span.journey_time_limit", ColumnType.INTEGER));
