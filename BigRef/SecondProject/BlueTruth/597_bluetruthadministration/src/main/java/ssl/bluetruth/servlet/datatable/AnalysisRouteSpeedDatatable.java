 ...
 */
public class AnalysisRouteSpeedDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(AnalysisRouteSpeedDatatable.class);
    ...
    private static final String fileName = "route_graph_speed.csv";
    /** 
