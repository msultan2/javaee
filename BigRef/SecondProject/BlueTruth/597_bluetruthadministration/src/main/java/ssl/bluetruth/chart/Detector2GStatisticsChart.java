 ...
 */
public class Detector2GStatisticsChart extends Chart {
    private static final String DETECTOR_2G_SIGNAL_LEVEL_SQL
            =            "SELECT detection_timestamp AT TIME ZONE '%s' AS detected_timestamp, sl_2g_min, sl_2g_avg, sl_2g_max "
    ...
    public Detector2GStatisticsChart(Rectangle chartSize, String mimetype, String detector, Period period, String timezone) throws BlueTruthException {
        super(new StringBuilder()
                ...
                period, chartSize, mimetype,
                "2G Signal Statistics", detector,
                xyScatter(),
                dateAxis("Detection Time", "yyyy-MMM-dd HH:mm", period),
                numberAxis("Signal level"),
                query(String.format(DETECTOR_2G_SIGNAL_LEVEL_SQL, timezone),
                ...
                intTimeSeries("Minimum", DETECTION_TIMESTAMP_XFIELD, "sl_2g_min",
                        lines(Color.RED)),

                intTimeSeries("Average", DETECTION_TIMESTAMP_XFIELD, "sl_2g_avg",
                        lines(Color.BLUE)),
                
                intTimeSeries("Maximum", DETECTION_TIMESTAMP_XFIELD, "sl_2g_max",
                        lines(Color.GRAY)));
    }
}
