...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Cloud Instation - Analysis / Spans /  <%=span%> - Speed</title>
        <%@include file="common/common-head.jsp" %>
        <script type="text/javascript" language="javascript" src="js/analysis-span-speed.js"></script>
    ...
    <body>
        <div id="content">
            ...
            <h1><a href="/Analysis">Analysis</a> / <a href="/AnalysisSpans">Spans</a> / <%=span%> - Speed</h1>
                ...
                <div id="graph-controls-dialog" class="control-group information-panel" title="Graph Controls">                    
                    <form id="control-form">
                        <div class="control" id="date-controls">
                            ...
                            <div>
                                <label>Max Speed (MPH):</label><input name="max_speed" value="100">
                            </div>
                        </div>
