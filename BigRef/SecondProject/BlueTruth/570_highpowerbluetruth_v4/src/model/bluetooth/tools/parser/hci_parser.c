...
#define LE_EV_NUM 5
char *ev_le_meta_str[LE_EV_NUM + 1] = {
	"Unknown",
...
char *cmd_linkctl_str[CMD_LINKCTL_NUM + 1] = {
	"Unknown",
	"Inquiry",
	"Inquiry Cancel",
...
char *cmd_linkpol_str[CMD_LINKPOL_NUM + 1] = {
	"Unknown",
	"Hold Mode",
	"Unknown",
	"Sniff Mode",
...
char *cmd_hostctl_str[CMD_HOSTCTL_NUM + 1] = {
	"Unknown",
	"Set Event Mask",
	"Unknown",
	"Reset",
...
char *cmd_info_str[CMD_INFO_NUM + 1] = {
	"Unknown",
...
char *cmd_status_str[CMD_STATUS_NUM + 1] = {
	"Unknown",
...
char *cmd_testing_str[CMD_TESTING_NUM + 1] = {
	"Unknown",
	"Read Loopback Mode",
	"Write Loopback Mode",
...
char *error_code_str[ERROR_CODE_NUM + 1] = {
	"Success",
	"Unknown HCI Command",
