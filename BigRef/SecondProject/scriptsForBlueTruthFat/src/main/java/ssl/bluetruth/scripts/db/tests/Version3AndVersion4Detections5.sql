DO $$
    DECLARE  
        test varchar := 'V3andV4Detections5';
...
RAISE INFO '%', test; 
    ...
    INSERT INTO detector VALUES (v3DetectorId, v3DetectorId, 1, 'North', 'default', 51.513242, -2.517142, 'testing v3 and v4 device ID compatibility', 1561, true);
    INSERT INTO detector VALUES (v4DetectorId, v4DetectorId, 1, 'North', 'default', 51.460369, -2.582499, 'testing v3 and v4 device ID compatibility', 1562, true);
