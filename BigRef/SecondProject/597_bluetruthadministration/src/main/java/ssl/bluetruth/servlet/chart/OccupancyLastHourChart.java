 ...
 * @author nthompson
 */
public class OccupancyLastHourChart extends HttpServlet {
    ...
    private final static String OCCUPANCY_LAST_HOUR_SQL = "SELECT "
            ...
            + "FROM occupancy "
            + "WHERE detector_id = ? "
            + "AND reported_timestamp > (now() - '01:00:00'::interval) "
    ...
    public JFreeChart getOccupancyLastHourGraph(String detectorName, String detectorId, String timezone) {
        ...
        JFreeChart chart = ChartFactory.createStackedXYAreaChart(
                "Traffic Flow recorded at detector '" + detectorName + "' in the last hour.", // title
