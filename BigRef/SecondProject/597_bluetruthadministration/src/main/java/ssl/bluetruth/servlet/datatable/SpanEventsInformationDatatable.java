 ...
 */
public class SpanEventsInformationDatatable extends AbstractDatatable{

     private static final Logger LOGGER = LogManager.getLogger(SpanEventsInformationDatatable.class);
     private static final String TABLE_NAME = "span_events_information "
            + "JOIN ( "
            ...
            + ") available ON available.span_name = span_events_information.span_name";

    private final String SPAN_NAME_REQUEST = "span_name";
    private final String SPAN_NAME_DB = "span_events_information.span_name";
    private final JsonResponseProcessor responseProcessor = new JsonResponseProcessor();
    private static final String fileName = "span_events.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        columns.add(new DataTableColumnDef("Event Id", "span_events_information.event_id", ColumnType.INTEGER));
        columns.add(new DataTableColumnDef("Description", "span_events_information.description", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Start Timestamp", "span_events_information.start_timestamp AT TIME ZONE '"+timezone+"'", ColumnType.DATE));
        columns.add(new DataTableColumnDef("End Timestamp", "span_events_information.end_timestamp AT TIME ZONE '"+timezone+"'", ColumnType.DATE));
        return columns;
    }
