...
import static ssl.bluetruth.chart.Chart.multiSeriesTotal;
 ...
 * @author pwood
 */
public class RouteDurationTotalChart extends Chart {
    ...
    public RouteDurationTotalChart(Rectangle chartSize, String mimetype, String routeName, Period period, Average average, String timezone) throws BlueTruthException {
        super(new StringBuilder()
                ...
                multiSeriesTotal(DETECTION_TIMESTAMP_XFIELD, "duration_median", "span_name")
                .gt("duration_median", 0)
                .when(average.isMedian()),
                
                multiSeriesTotal(DETECTION_TIMESTAMP_XFIELD, "duration_mean", "span_name")
                .gt("duration_mean", 0)
                .when(average.isMean()),

                multiSeriesTotal(DETECTION_TIMESTAMP_XFIELD, "duration_mode", "span_name")
                .gt("duration_mode", 0)
                .when(average.isMode()));
    }
}
