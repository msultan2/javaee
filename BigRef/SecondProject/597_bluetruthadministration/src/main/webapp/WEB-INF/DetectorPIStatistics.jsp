...
<html>
    <head>
        ...
        <meta http-equiv="REFRESH" content="0; url=DetectorPerformanceIndex">
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Cloud Instation - Live Report / Detector Status /  <%=detector_id%> - Detection Performance Index</title>
        <%@include file="common/common-head.jsp" %>
        <script type="text/javascript" language="javascript" src="js/detector-pi-statistics.js"></script>
    ...
    <body>
        <div id="content">
            ...
            <h1><a href="/Report">Live Report</a> / <a href="/DetectorStatus">Detector Status</a> / <%=detector_id%> - Detector Performance Index</h1>
            ...
            <h2>Detector Performance Index Data</h2>
