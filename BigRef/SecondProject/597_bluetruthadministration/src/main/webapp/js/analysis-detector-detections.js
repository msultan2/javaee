var graph_url = "/AnalysisChart/DetectorDetectionsChart";

function init_analysis_detector(detector_id){
    ...
    create_analysis_detector_table(detector_id);
...
function create_analysis_detector_table(detector_id){
...
function create_detector_datatable_config(detector_id,filter_div){
    ...
    datatable_config.sAjaxSource = "AnalysisDetectorDetectionsDatatable";
