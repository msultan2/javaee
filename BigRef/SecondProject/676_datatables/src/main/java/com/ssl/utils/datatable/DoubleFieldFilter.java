 ...
 */
public class DoubleFieldFilter extends AbstractFieldFilter implements DataTableFieldFilter {
     ...
     */
    public DoubleFieldFilter(String fieldName, Double min, Double max, boolean minInclusive, boolean maxInclusive) {
        super(fieldName);
