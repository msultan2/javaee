...
/**
 * Created for SCJS 008
 * @author svenkataramanappa
 */
public class SpanIncidentsInformationDatatable extends AbstractDatatable{

     private static final Logger LOGGER = LogManager.getLogger(SpanIncidentsInformationDatatable.class);
     private static final String TABLE_NAME = "span_incidents_information "
            + "JOIN ( "
            ...
            + ") available ON available.span_name = span_incidents_information.span_name";

    private final String SPAN_NAME_REQUEST = "span_name";
    private final String SPAN_NAME_DB = "span_incidents_information.span_name";
    ...
    private static final String fileName = "span_incidents.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        columns.add(new DataTableColumnDef("Incident Id", "span_incidents_information.incident_id", ColumnType.INTEGER));
        columns.add(new DataTableColumnDef("Description", "span_incidents_information.description", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Start Timestamp", "span_incidents_information.start_timestamp AT TIME ZONE '"+timezone+"'", ColumnType.DATE));
        columns.add(new DataTableColumnDef("End Timestamp", "span_incidents_information.end_timestamp AT TIME ZONE '"+timezone+"'", ColumnType.DATE));
        return columns;
    }
