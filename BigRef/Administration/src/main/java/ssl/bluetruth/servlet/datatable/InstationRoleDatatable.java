 ...
 * @author nthompson
 */
public class InstationRoleDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(InstationRoleDatatable.class);
    ...
    private static final String fileName = "roles.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Role", "role_name", ColumnType.STRING));
