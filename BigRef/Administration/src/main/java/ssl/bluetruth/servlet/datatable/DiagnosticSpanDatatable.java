...
public class DiagnosticSpanDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(DiagnosticSpanDatatable.class);
    ...
    private static final String fileName = "diagnostic_spans.csv";
