...
/**
 * SCJS 015 START - Brand Management datatable
 * @author Santhosh
 */
public class BrandManagementDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(BrandManagementDatatable.class);
    private static final String TABLE_NAME = "branding ";
    ...
    private static final String fileName = "brands.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Brand Name", "branding.brand", ColumnType.STRING));
        columns.add(new DataTableColumnDef("CSS URL", "branding.css_url", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Website", "branding.website_address", ColumnType.STRING));
    }
