...
import ssl.bluetruth.chart.SpanDurationChart;
 ...
 * @author pwood
 */
public class SpanDurationChartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest httpServletRequestrequest, HttpServletResponse response)
        ...
        Chart chart = 
                makeChart(SpanDurationChart.class,
                ...
                request.time("max_duration", "HH:mm:ss", "00:00:00", 5 * 60 * 1000),
                request.bool("detections", false),
                request.bool("outliers", false),
                request.average("average", "median"),
                timezone);
