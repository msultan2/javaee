...
import ssl.bluetruth.chart.DetectionChart;
 ...
 * @author pwood
 */
public class DetectionChartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest httpServletRequestrequest, HttpServletResponse response)
        ...
        Chart chart = 
                makeChart(DetectionChart.class,
