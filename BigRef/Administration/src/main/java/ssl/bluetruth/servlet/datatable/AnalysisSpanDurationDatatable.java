 ...
 */
public class AnalysisSpanDurationDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(AnalysisSpanDurationDatatable.class);
    ...
    private static final String fileName = "span_graph_duration.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        columns.add(new DataTableColumnDef("Duration", "to_char(span_journey_detection.duration, 'HH24:MI:SS')", ColumnType.INTERVAL, "span_journey_detection.duration"));
        columns.add(new DataTableColumnDef("Mean", "to_char(span_journey_detection_analytics.duration_mean, 'HH24:MI:SS')", ColumnType.INTERVAL, "span_journey_detection_analytics.duration_mean"));
        columns.add(new DataTableColumnDef("Median", "to_char(span_journey_detection_analytics.duration_median, 'HH24:MI:SS')", ColumnType.INTERVAL, "span_journey_detection_analytics.duration_median"));
        columns.add(new DataTableColumnDef("Mode", "to_char(span_journey_detection_analytics.duration_mode, 'HH24:MI:SS')", ColumnType.INTERVAL, "span_journey_detection_analytics.duration_mode"));
