 ...
 */
public class Detector2GStatisticsDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(Detector2GStatisticsDatatable.class);
    ...
    private static final String fileName = "detector_2g_statistics.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        tableColumns.add(new DataTableColumnDef("2G Signal Level Min", "detector_performance.sl_2g_min", ColumnType.INTEGER));
        tableColumns.add(new DataTableColumnDef("2G Signal Level Avg", "detector_performance.sl_2g_avg", ColumnType.INTEGER));
        tableColumns.add(new DataTableColumnDef("2G Signal Level Max", "detector_performance.sl_2g_max", ColumnType.INTEGER));       
        return tableColumns;
    }
