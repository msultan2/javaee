...
import ssl.bluetruth.chart.SpanSpeedChart;
 ...
 * @author pwood
 */
public class SpanSpeedChartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest httpServletRequestrequest, HttpServletResponse response)
        ...
        Chart chart = 
                makeChart(SpanSpeedChart.class,
