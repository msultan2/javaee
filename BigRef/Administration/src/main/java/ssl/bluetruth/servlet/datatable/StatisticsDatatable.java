 ...
 * @author liban
 */
public class StatisticsDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(StatisticsDatatable.class);
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        tableColumns.add(new DataTableColumnDef("ID", "statistics_report.report_id", ColumnType.INTEGER));
        tableColumns.add(new DataTableColumnDef("Detector", "detector.detector_name", ColumnType.STRING));
        tableColumns.add(new DataTableColumnDef("Report Start", "statistics_report.report_start AT TIME ZONE '" + timezone + "'", ColumnType.DATE));
        tableColumns.add(new DataTableColumnDef("Report End", "statistics_report.report_end AT TIME ZONE '" + timezone + "'", ColumnType.DATE));
        return tableColumns;
    }
