...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Analysis / Routes /  <%=route%> - Speed</title>
        <%@include file="common/common-head.jsp" %>
        <script type="text/javascript" language="javascript" src="js/analysis-route-speed.js"></script>
    ...
    <body>
        <div id="content">
            ...
            <h1><a href="/Analysis">Analysis</a> / <a href="/AnalysisRoutes">Routes</a> / <%=route%> - Speed</h1>
