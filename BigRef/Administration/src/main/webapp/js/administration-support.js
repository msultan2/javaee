...
function init_administration_support(){
    create_email_table();
...
function create_email_table(){
    ...
    var brand_email_datatable_config = create_brand_email_datatable_config(filter_div, table);
    ...
    .append(create_csv_download_button({
        ...
        datatable:datatable,
        parameters : [{"name":"contact_method", "value":"email"}],
        ajax_url:brand_email_datatable_config.sAjaxSource
    }))
...
function create_phone_table(){
    var table = $("#brand-phone-table");
    var filter_div = $("<div/>");
    var table_headers = $("th", table);
    var brand_phone_datatable_config = create_brand_phone_datatable_config(filter_div, table);
    ...
    .append(create_csv_download_button({
        filter_div:filter_div,
        datatable:datatable,
        parameters : [{"name":"contact_method", "value":"phone"}],
        ajax_url:brand_phone_datatable_config.sAjaxSource
    }))
    .append(create_show_hide_column_button({
...
function create_brand_email_datatable_config(filter_div, table){
    ...
    datatable_config.sAjaxSource = "AdministrationSupportDatatable";
...
function create_brand_phone_datatable_config(filter_div, table){
    var datatable_config = common_datatable_configuration();
    datatable_config.aoColumnDefs = [
    {
        "sClass":"text center",
