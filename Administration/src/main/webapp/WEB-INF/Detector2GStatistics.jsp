...
<html>
    <head>
        ...
        <meta http-equiv="REFRESH" content="0; url=DetectorTwoGStatistics">
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Cloud Instation - Live Report / Detector Status /  <%=detector_id%> - Detection 2G Statistics</title>
        <%@include file="common/common-head.jsp" %>
        <script type="text/javascript" language="javascript" src="js/detector-2g-statistics.js"></script>
    ...
    <body>
        <div id="content">
            ...
            <h1><a href="/Report">Live Report</a> / <a href="/DetectorStatus">Detector Status</a> / <%=detector_id%> - Detector 2G Statistics</h1>
