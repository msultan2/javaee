 ...
 */
public class Detector3GStatisticsDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(Detector3GStatisticsDatatable.class);
    ...
    private static final String fileName = "detector_3g_statistics.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        tableColumns.add(new DataTableColumnDef("3G Signal Level Min", "detector_performance.sl_3g_min", ColumnType.INTEGER));
        tableColumns.add(new DataTableColumnDef("3G Signal Level Avg", "detector_performance.sl_3g_avg", ColumnType.INTEGER));
        tableColumns.add(new DataTableColumnDef("3G Signal Level Max", "detector_performance.sl_3g_max", ColumnType.INTEGER));       
        return tableColumns;
    }
