 ...
 * @author nthompson
 */
public class LogicalGroupSpanDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(LogicalGroupSpanDatatable.class);
    private static final String TABLE_NAME = "span "
            ...
            + "LEFT JOIN span_logical_group "
            + "ON span.span_name = span_logical_group.span_name "
    ...
    private static final String fileName = "logical_group_spans.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Logical Group Name", "span_logical_group.logical_group_name", ColumnType.STRING));   
    }
