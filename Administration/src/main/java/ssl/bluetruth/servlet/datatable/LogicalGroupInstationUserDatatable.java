 ...
 * @author nthompson
 */
public class LogicalGroupInstationUserDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(LogicalGroupInstationUserDatatable.class);
    private static final String TABLE_NAME = "instation_user "
            + "LEFT JOIN instation_user_logical_group "
            + "ON instation_user.username = instation_user_logical_group.username "
    ...
    private static final String fileName = "logical_group_users.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Name", "instation_user.full_name", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Description", "instation_user.username", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Logical Group Name", "instation_user_logical_group.logical_group_name", ColumnType.STRING));
    }
