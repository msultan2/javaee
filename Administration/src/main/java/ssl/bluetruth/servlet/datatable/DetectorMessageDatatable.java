 ...
 * @author nthompson
 */
public class DetectorMessageDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(DetectorMessageDatatable.class);
    private static final String TABLE_NAME = "detector_message "
            + "JOIN ( "
            ...
            + ") available ON available.detector_id = detector_message.detector_id";
    ...
    private final String DETECTOR_ID_DB = "detector_message.detector_id";
    private static final String fileName = "detector_messages.csv";
    ...
    protected List<DataTableColumnDef> getColumns(HttpServletRequest request) {
        ...
        columns.add(new DataTableColumnDef("Code", "detector_message.code", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Category", "detector_message.category", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Description", "detector_message.description", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Description Detail", "detector_message.description_detail", ColumnType.STRING));
        columns.add(new DataTableColumnDef("Count", "detector_message.count", ColumnType.INTEGER));
        columns.add(new DataTableColumnDef("Recorded Timestamp", "detector_message.recorded_timestamp AT TIME ZONE '"+timezone+"'", ColumnType.DATE));
        return columns;
    }
