 ...
 * @author nthompson
 */
public class LogicalGroupRouteDatatable extends AbstractDatatable {

    private static final Logger LOGGER = LogManager.getLogger(LogicalGroupRouteDatatable.class);
    private static final String TABLE_NAME = "route "
            + "LEFT JOIN route_logical_group "
            + "ON route.route_name = route_logical_group.route_name "
    ...
    private static final String fileName = "logical_group_routes.csv";
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        columns.add(new DataTableColumnDef("Logical Group Name", "route_logical_group.logical_group_name", ColumnType.STRING));   
    }
