...
import ssl.bluetruth.chart.DetectorPerformanceIndexChart;
 ...
 */
public class DetectorPerformanceIndexChartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest httpServletRequestrequest, HttpServletResponse response)
        ...
        Chart chart = 
                makeChart(DetectorPerformanceIndexChart.class, 
