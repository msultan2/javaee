...
import ssl.bluetruth.chart.Detector3GStatisticsChart;
 ...
 */
public class Detector3GStatisticsChartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest httpServletRequestrequest, HttpServletResponse response)
        ...
        Chart chart = 
                makeChart(Detector3GStatisticsChart.class,
