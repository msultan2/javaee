...
public class HelloServiceLocator extends org.apache.axis.client.Service implements uk.ac.open.t320.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:13265/HelloEsraa/services/Hello";
    ...
    public uk.ac.open.t320.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.open.t320.HelloSoapBindingStub _stub = new uk.ac.open.t320.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.open.t320.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.open.t320.HelloSoapBindingStub _stub = new uk.ac.open.t320.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://t320.open.ac.uk", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://t320.open.ac.uk", "Hello"));
        }
